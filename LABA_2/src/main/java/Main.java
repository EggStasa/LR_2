public class Main {
    public static void main(String[] args) {
        ...
        //Add Book
        library.add(new Book("Сутінки", "Стефані Маєр", "12624563", "1251","1835"));
        library.add(new Book("Відьмак", "Анджей Сапковський", "1834564", "1241","1265"));
        library.add(new Book("Замок", "Франц Кафка", "1446563", "1231","1926"));
        library.add(new Book("Сталкер", "Сергій Недоруб", "6434546", "1281","1819"));

        //Add DVD
        library.add(new DVD("Коротко про C++", "3462256", 120));
        library.add(new DVD("Коротко про Java Script", "3462253", 30));
        ...
        //Old
        library.findItemAtName("Сталкер");
    }
}
